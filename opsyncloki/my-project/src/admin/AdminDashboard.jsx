    ...
    const fetchData = async () => {
      try {
        ...
        const [trainersRes, traineesRes, batchesRes] = await Promise.all([
          axios.get("https://lokyexamplecom.pythonanywhere.com/trainers/", { headers }),
          axios.get("https://lokyexamplecom.pythonanywhere.com/trainees/", { headers }),
          axios.get("https://lokyexamplecom.pythonanywhere.com/batches-list/", { headers }),
