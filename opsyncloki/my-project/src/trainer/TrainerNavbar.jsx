...
const TrainerNavbar = ({ sidebarCollapsed }) => {
  return (
    <nav 
    ...
    >
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            {/* Notifications */}
            <button className="relative p-2 text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors duration-200">
              <Bell size={20} />
            ...
            <div className="flex items-center space-x-3">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs text-gray-500"> Traiee Portal</p>
              </div>
              <div className="relative group">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyNvaZKaEZ_zp_qEeY9xYmzE83DFfdNUdk4w&s"
                  alt="Companny Logo"
                  className="w-10 h-10 rounded-full object-cover border-2 border-indigo-200 shadow-sm cursor-pointer group-hover:border-indigo-400 transition-colors duration-200"
                />
                ...
                <div className="absolute right-0 top-12 w-48 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2">
                  <div className="p-3 border-b border-gray-100">
                    ...
                    <p className="text-sm text-gray-500">trainer@techcorp.com</p>
                  </div>
                  <ul className="py-2">
                    <li>
